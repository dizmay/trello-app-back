...
const { auth, boards, usersBoards, inviteBoard, boardColumns, columnsTasks, assignedUsers } = require('./api/routes');
...
app.use('/api/columns-tasks', columnsTasks);
app.use('/api/assign-user', assignedUsers);
